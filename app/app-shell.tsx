    ...
    <div className="ln-shell">
      ...
      >
        ...
        <div className="ln-sidebar-footer">
          ...
          {!isNavCollapsed ? (
            <div className="ln-version-label" aria-label={`Application version ${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.5.6"}`}>
              Version {process.env.NEXT_PUBLIC_APP_VERSION ?? "0.5.6"}
            </div>
          ) : null}
        </div>
      </aside>
