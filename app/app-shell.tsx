    ...
    <div className="ln-shell">
      ...
      >
        ...
        <div className="ln-sidebar-footer">
          ...
          <div className="ln-version-label" aria-label={`Application version ${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.5.19"}`}>
            {isNavCollapsed
              ? `v${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.5.19"}`
              : `Version ${process.env.NEXT_PUBLIC_APP_VERSION ?? "0.5.19"}`}
          </div>
        </div>
      </aside>
